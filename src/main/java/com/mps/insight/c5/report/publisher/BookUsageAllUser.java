...
public class BookUsageAllUser {
	...
	public BookUsageAllUser(Counter5DTO c5Dto, RequestMetaData rmd) {
	...
	private String getQuery(String download) {
		...
		String tableName = "c5_book_usage_all_users"; //from config/hardcode/tabvle/xtz/etc
		String totalOfmonth="";
		try {
			...
			/*query.append("select "+coloumTitle+dynamicmonth)
			.append(totalOfmonth+" from "+tableName+" ORDER BY title");*/
