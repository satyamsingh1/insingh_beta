...
public class PR_P1 {
	...
	public PR_P1(Counter5DTO dto,String previewType,RequestMetaData rmd) {
		this.dto = dto;
	...
	private String generatePRP1Query() {
		StringBuilder query = new StringBuilder();
		try {
			query.append("SELECT ");
			query.append(" " + InsightConstant.PR_P1_MASTER_TITLE_1 + ", "); 
			...
			query.append(InsightConstant.PR_P1_WHERE_CONDITION +" AND ");
			query.append(" Institution_ID='" + dto.getInstitutionID() + "' ");
			query.append(" GROUP BY  " + InsightConstant.PR_P1_MASTER_TITLE_1 );
			...
			query.append(" Institution_ID='" + dto.getInstitutionID() + "' AND ");
			query.append(InsightConstant.PR_P1_WHERE_CONDITION2 );
			query.append(" GROUP BY  " + InsightConstant.PR_P1_MASTER_TITLE_1 );
			...
			rmd.exception("generatePRP1Query : unable to create Query : "+e.toString());
		}
