...
public class TR_B1 {
	...
	public TR_B1(Counter5DTO dto,String previewType,RequestMetaData rmd){
		this.dto=dto;
	...
	private String generateTRB1Query(){
		...
		try {
			...
			query .append("`Parent_Online_ISSN` As 'Online_ISSN',`Parent_URI` as 'URI',"); 
			query .append("`YOP` as 'YOP', `Metric_Type`, "); 
			...
			query.append(" and "+InsightConstant.TR_B1_WHERE_CONDITION); 
			...
			rmd.exception("generateTRB1Query : unable to create Query : "+e.toString());
		}
