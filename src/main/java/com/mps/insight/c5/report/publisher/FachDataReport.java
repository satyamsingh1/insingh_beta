...
public class FachDataReport {
	...
	public FachDataReport(Counter5DTO c5Dto, RequestMetaData rmd) {
	...
	private String getQuery(String download) {
		...
		int fromYear = 0;
		 if (null != dto.getFrequency() && dto.getFrequency().contains("MONTHLY")) {
			...
			queryMonth = createDailyQueryForMonth(today, toMonth, toYear, fromday, fromMonth, fromYear);
		}
		String tableName = "c5_ip_daily_hits";
