...
public class JournalUsageAllInstitution {
	...
	public JournalUsageAllInstitution(Counter5DTO c5Dto, RequestMetaData rmd) {
	...
	private String getQuery(String download) {
		...
		String tableName = "c5_journal_usage_all_institution"; //from config/hardcode/tabvle/xtz/etc
		String totalOfmonth="";
		try {
			...
			.append(" from "+tableName+" GROUP BY `title`,`publisher`,`platform`,`print_issn`,`online_issn`, metric_type, "+totalOfmonth+" ORDER BY title");
