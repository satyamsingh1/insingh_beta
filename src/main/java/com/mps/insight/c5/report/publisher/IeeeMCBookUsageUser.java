...
public class IeeeMCBookUsageUser {
	...
	public IeeeMCBookUsageUser(Counter5DTO c5Dto, RequestMetaData rmd) {
	...
	private String getQuery(String download) {
		...
		String tableName = "c5_ieee_m_c_book_usage_by_month_all_user "; 
		try {
