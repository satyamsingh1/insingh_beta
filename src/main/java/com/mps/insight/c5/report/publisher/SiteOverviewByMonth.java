...
public class SiteOverviewByMonth {

	private Counter5DTO dto = null;
	private Counter5ReportsDao c5dao = null;
	private String coloumTitle = "`JOURNAL_ID`, `JOURNAL_TITLE`, `PUBLISHER`, `PLATFORM`, `ONLINE_ISSN`, `PRINT_ISSN`,";

	public SiteOverviewByMonth(Counter5DTO c5Dto, RequestMetaData rmd) {
	...
	private String getQuery() {
		...
		String tableName = "c5_site_overview_by_month"; //from config/hardcode/tabvle/xtz/etc
		try {
