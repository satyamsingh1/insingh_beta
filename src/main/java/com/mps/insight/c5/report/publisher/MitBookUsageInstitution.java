...
public class MitBookUsageInstitution {
	
	private Counter5DTO dto = null;
	private Counter5ReportsDao c5dao = null;
	private String coloumTitle = " Book,Publisher,Platform,ISBN, YOP AS `Copyright Year`, metric_type AS `Metric_Type`,";
	private String groupTitle = " GROUP BY `Book`,`Publisher`,`Platform`,`ISBN`, `YOP`,metric_type, ";
	public MitBookUsageInstitution(Counter5DTO c5Dto, RequestMetaData rmd) {
	...
	private String getQuery(String download) {
		...
		String tableName = "c5_mit_book_usage_by_month_all_institution "; 
		try {
