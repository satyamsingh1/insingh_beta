...
public class IeeeMCBookUsageInstitution {
	private Counter5DTO dto = null;
	private Counter5ReportsDao c5dao = null;
	private String coloumTitle = " Book,Publisher,Platform,ISBN, Metric_type AS Metric_Type,";
	private String groupTitle = " GROUP BY `Book`,`Publisher`,`Platform`,`ISBN`, Metric_type,";
	public IeeeMCBookUsageInstitution(Counter5DTO c5Dto, RequestMetaData rmd) {
	...
	private String getQuery(String download) {
		...
		String tableName = "c5_ieee_m_c_book_usage_by_month_all_institution "; 
		try {
