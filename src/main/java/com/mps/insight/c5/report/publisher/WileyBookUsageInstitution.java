...
public class WileyBookUsageInstitution {
	...
	public WileyBookUsageInstitution(Counter5DTO c5Dto, RequestMetaData rmd) {
	...
	private String getQuery(String download) {
		...
		String tableName = "c5_wiley_book_usage_by_month_all_institution"; 
		try {
